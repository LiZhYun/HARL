...
from harl.utils.models_tools import init_device, check
...
from harl.models.base.action_attention import Action_Attention
...
class OffPolicyBaseRunner:
    ...
    def __init__(self, args, algo_args, env_args):
        ...
        if (
            ...
            self.alpha = self.algo_args["algo"]["alpha"]
